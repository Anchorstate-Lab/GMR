...
hand-written, they are generated by `expand()`, and every shape has that one entry
point. A shape carrying its own rule table would be a second capture path, walked
by nobody and checked by nothing — which is why there is one generator and no
hand-written tables beside it.
